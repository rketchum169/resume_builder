<html>
 ...
 <input type="text" value="" name="start_date1" />
 ...
 <label>Start Date</label>
 <input type="text" value="" name="start_date2" />
 <label>End Date</label>
 ...
 <label>Start Date</label>
 <input type="text" value="" name="start_date3" />
 <label>End Date</label>
 ...
 <label>Start Date</label>
 <input type="text" value="" name="start_date4" />
 <label>End Date</label>
